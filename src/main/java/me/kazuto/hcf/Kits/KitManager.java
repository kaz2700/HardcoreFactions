...
public class KitManager {
  @Getter private HashMap<Player, Kit> playerKits = new HashMap<>();

  @Getter private List<Kit> kits = List.of(Bard.getInstance(), Kamikaze.getInstance());
  ...
  private void addEffectsToPlayer(Player player, Kit kit) {
    for (PotionEffect potionEffect : kit.getEffects()) player.addPotionEffect(potionEffect);
  }
