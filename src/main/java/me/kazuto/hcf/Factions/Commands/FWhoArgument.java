...
public class FWhoArgument extends CommandArgument {
    public FWhoArgument() {
        super("who", "Show faction information.", "/f who <faction/player>", new ArrayList<>(asList("i", "info", "information", "show")));
    }
        ...
        switch(strings.length) {
            case 1: // /F who
                if (!(commandSender instanceof Player)) {
                    commandSender.sendMessage(String.format("%s%sYou are the console so you dont have a faction", Config.ERROR_COLOR, Config.ERROR_PREFIX));
                    return false;
                }
            ...
            case 2:
                ...
                if(output.isEmpty()) {
                   commandSender.sendMessage(String.format("%s%sNo faction found.", Config.ERROR_COLOR, Config.ERROR_PREFIX));
                }
