...
public abstract class FastBoardBase<T> {
	 ...
	 *            the new line text
	 * @throws IndexOutOfBoundsException
	 *             if the line is higher than {@link #size() size() + 1}
	 */
	 ...
	 *            the new line text
	 * @param scoreText
	 *            the new line's score, if null will not change current value
	 * @throws IndexOutOfBoundsException
	 *             if the line is higher than {@link #size() size() + 1}
	 */
	 ...
	 *            the new scoreboard lines
	 * @param scores
	 *            the set for how each line's score should be, if null will fall
	 *            back to default (blank)
	 * @throws IllegalArgumentException
	 *             if one line is longer than 30 chars on 1.12 or lower
	 * @throws IllegalArgumentException
	 *             if lines and scores are not the same size
	 * @throws IllegalStateException
	 *             if {@link #delete()} was call before
	 */
	 ...
	 *            the line number
	 * @param text
	 *            the text to be displayed as the score. if null, no score will be
	 *            displayed
	 * @throws IllegalArgumentException
	 *             if the line number is not in range
	 * @throws IllegalStateException
	 *             if {@link #delete()} was call before
	 */
	 ...
	 *
	 * @param texts
	 *            the set of texts to be displayed as the scores
	 * @throws IllegalArgumentException
	 *             if the size of the texts does not match the current size of the
	 *             board
	 * @throws IllegalStateException
	 *             if {@link #delete()} was call before
	 */
